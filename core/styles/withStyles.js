...
var _createGenerateClassName = _interopRequireDefault(
  require("./createGenerateClassName")
);
...
var withStylesOld = function withStylesOld(stylesOrCreator) {
  ...
  return function(Component) {
    ...
    var _options$withTheme = options.withTheme,
      ...
      name = options.name,
      styleSheetOptions = (0, _objectWithoutProperties2.default)(options, [
        "withTheme",
        "flip",
        "name"
      ]);
    ...
    var listenToTheme =
      stylesCreator.themingEnabled || typeof name === "string" || withTheme;
    indexCounter += 1;
    ...
    if (process.env.NODE_ENV !== "production") {
      WithStyles.displayName = "WithStyles(".concat(
        (0, _utils.getDisplayName)(Component),
        ")"
      );
    }
